  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="max-w-3xl mx-auto px-6 py-20 text-center">
        ...
        <div className="mt-12 rounded-2xl border border-red-900/50 bg-zinc-900 p-8 text-left shadow-2xl">
          <div className="flex items-baseline justify-between">
            <div>
              <h2 className="text-xl font-bold text-zinc-100">Free</h2>
              <p className="text-sm text-zinc-500">All features, no limits, during beta.</p>
            </div>
            <div className="text-right">
              <span className="text-4xl font-black text-red-500">$0</span>
              <span className="block text-xs text-zinc-500">per month</span>
            </div>
          </div>
          ...
          <Link
            href="/auth/sign-up"
            className="mt-8 block w-full rounded-lg bg-red-600 px-4 py-3 text-center font-semibold text-white hover:bg-red-500"
          >
            Start free
          </Link>
          {stripeEnabled === false && (
            <p className="mt-3 text-center text-xs text-zinc-600">Paid plans are not enabled yet. Everything is included free.</p>
          )}
        </div>
