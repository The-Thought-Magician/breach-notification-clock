...
// GET / — auth — caller's notifications (newest first)
...
// PUT /:id/read — auth — mark one notification read (ownership-checked)
...
// PUT /read-all — auth — mark all caller's notifications read
