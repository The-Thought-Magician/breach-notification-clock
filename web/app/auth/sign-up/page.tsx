    ...
    <main className="min-h-screen bg-zinc-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold mt-5 text-zinc-100">Create your account</h1>
          <p className="mt-1 text-sm text-zinc-500">Be ready before the next incident, not during it.</p>
        </div>
        <form onSubmit={handleSubmit} className="bg-zinc-900 rounded-xl border border-zinc-800 p-8 space-y-4">
          ...
          <div>
            ...
            <input name="name" type="text" required className="w-full bg-zinc-800 border border-zinc-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-red-500" placeholder="Your name" />
          </div>
          <div>
